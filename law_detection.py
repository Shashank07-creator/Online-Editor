...
class detect():
    def __init__(self):
        ...
        self.offence = {'murder':[300,'XVI'],'robbery':['390-402','XVII'],'theft':['378-382','XVII'],'cheating':['415-420','XVII'],'attempt':[511,'XXIII']}
        self.crime=[]
        self.support = {}
    ...
    def template(self,l):
        ...
        for i in l:
            temp = self.offence[i]
            #result+='{} under IPC Chapter {}, Section {} \n'.format(i.upper(),temp[1],temp[0])
            result+="<mark class=\"entity\" style=\"background: #feca74; padding: 0.45em 0.6em; margin: 0 0.25em; line-height: 1; border-radius: 0.35em;\">Chapter {} ,{} for {} <//mark>\n".format(temp[1],temp[0],i.upper())
        return result
